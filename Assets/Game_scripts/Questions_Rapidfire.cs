...
/*
public class Questions_Rapidfire : MonoBehaviour 
{
	...
	{
		questionid = new int[56];
		hintId = new int[56];
		question = new string[56];
		optionA = new string[56];
		optionB = new string[56];
		optionC = new string[56];
		optionD = new string[56];
		hints = new string[56];
		ca = new int[56];
		attemp = new int[56];
		next =new int[56]; 
